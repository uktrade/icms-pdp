...
def _edit_goods(
    ...
    goods_pk: int,
    goods_class: Union[
        Type[models.SILGoodsSection1],
        Type[models.SILGoodsSection2],
        Type[models.SILGoodsSection5],
        Type[models.SILGoodsSection582Obsolete],
        Type[models.SILGoodsSection582Other],
    ],
    ...
    with transaction.atomic():
        ...
        goods = get_object_or_404(goods_class, pk=goods_pk)
