...
from web.tests.domains.case._import.factory import (  # SanctionsAndAdhocLicenseApplicationFactory,
...
#  TODO refactor into license details page
...
#         self.url = f"/import/sanctions/applicant-details/{self.process.pk}/"
